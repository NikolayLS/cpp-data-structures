...
template<typename T>
std::vector<T> Graph<T>::indexesToT(const std::vector<size_t>& indexes)const
{
...
template<typename T>
std::vector<T> Graph<T>::parentsToPath(const std::vector<size_t>& parents,const size_t& startIndex, const size_t& endIndex)const
{
...
template<typename T>
void Graph<T>::dfs1StrongComponentsHelp(const size_t& vertex, std::vector<bool>& visited, std::stack<size_t>& s)const
{
...
template<typename T>
void Graph<T>::dfs2StrongComponentsHelp(const size_t& vertex, std::vector<bool>& visited, std::vector<size_t>& components,const size_t& comCount)const
{
	if (visited[vertex]) return;
	visited[vertex] = true;
